					...
					{isMobile ? (
						...
						<div>
							...
							<div className="blocking-screen-text">
								Where no matter what you do... you can't NOT be
								productive.{" "}
							</div>
							<div className="blocking-screen-text">
								You'll need the{" "}
								...
								extension to play (other browsers not supported
								yet, sorry!)
							</div>
							<div className="credits">
								<div className="blocking-screen-text">
									Have thoughts, questions, or bugs to report?
									Any{" "}
									<a
						...
						<div>
							...
							<div className="blocking-screen-text">
								We noticed you don't have the Bread Winner
								companion extension installed yet. Follow these
								links to the right extension page and we'll be
							...
							{visited ? (
								<div className="blocking-screen-hint">
									...
									allowing permissions if you're using the
									Firefox extension.
								</div>
							) : null}
						</div>
