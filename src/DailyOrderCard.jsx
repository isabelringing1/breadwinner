...
function DailyOrderCard(props) {
    ...
    var progressClass = "daily-order-info" + (order[2] < order[1] ? " notreached" : " reached")
    return ( <div id={"daily-order-card-" + i} className="daily-order-card">
        <img className="daily-order-bread" src={window.location.origin + "/images/" + order[0] + "_full.png"}/>
